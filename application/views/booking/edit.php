	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<!-- /.card-header -->
				<div class="card-body">
					<?php echo form_open_multipart('booking/edit/'.$booking['id_Booking']); ?>
                        <div class="row clearfix">
                            <div class="col-md-6">
                                ...
                                <select name="nisn" id="nisn" class="form-control">
									<option value="<?php echo $booking['nisn'] ?>"><?php echo $booking['nisn'] ?></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="kode_buku" id="kode" class="form-control">
                                    <option value="<?php echo $booking['kode_buku'] ?>"><?php echo $booking['kode_buku'] ?></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="tgl_pinjam" id="tgl_pinjam" value="<?php echo $booking['tgl_pinjam'] ?>">
                            </div>
                        </div>
